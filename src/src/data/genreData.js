export const genreData = {
    ...
    "sci-fi":[
        "A character who wakes up in a space pod alone…next to a ship so massive it’s actually carrying a planet beneath it. he has no memory from before they wake.",
        "A character who lives in a world where every single person’s DNA is carefully genetically designed for something to help the community. Your main character despises what they were created for. This has never happened before.",
        "He lives on a planet other than Earth. In fact, they don’t even know Earth exists. Well, they didn’t until some sort of advanced, technical probe crash-landed in their settlement, exposing the fact that they’re not alone. Now they have to decide what’s best for their settlement.",
        "The world used to be plagued with war and famine and inhumanity. But after years and years of developing a technical system that is the center of and controls everything, it’s almost completely peaceful. he is the engineer keeping the system running and when they uncover how it works, they contemplate abandoning everything they know.",
        "The newest advancement in virtual reality that adds a physical sense. Now your characters can even hook up with people through your phone, all while staying at home. But when a glitch alters the mechanisms, what was once pleasure becomes pain and the user gets trapped in a VR state.",
        "How others have been keeping he alive for over 300 years because of a secret they know. When someone new finally learns the truth, reality becomes…confusing. Now, with only a short adulthood left to live, he must ensure nobody else learns of this secret. But…well, news spreads fast.",
        "They didn’t mean to, but in an attempt to build a time traveling machine, he actually discovered alternate universes – and then accidentally trapped themselves there. Oh, and this alternate universe hasn’t discovered electricity yet.",
        "Character who lives in an ancient society. When a shiny, unnatural looking contraption touches down and creatures emerge, everything they once knew changes.",
        "The only reason he is alive is because of a test device implanted around their heart. It wasn’t supposed to work and now, they’re not only healed, but they’re also changing. Just what exactly was that device made out of?",
        "Character who wakes up in a dark, hot room dressed in hardly anything. Their memory is foggy but clearing up, and they have some sort of technical device securing their hands together. They stumble over to a tiny window that gives them a clear view of a world far below them.",
        "Character’s sister who is discovered dead and the cause of death ruled an overdose. he knows better. She was the only person in the family who never had an issue with drugs. In fact, she was developing a cure for cancer in the most advanced research center in the world. he finds that…suspicious.",
        "How computers are outlawed. Having access to technology is punishable by life in prison. he runs an underground cyber center that gets crashed by local law enforcement. But during interrogation, they get hired instead of prosecuted…because something unworldly has touched down.",
        "Character who accidentally created a virtual reality software that taps into the user’s psyche and creates their ultimate dream reality. They were on track to become a billionaire until some users became addicted and unable to free themselves from its hold.",
        "How the world he currently lives on is nearing its breaking point. While the rest of the world rushes to evacuate everyone to a space pod with a destination of a livable planet, he remains behind bars, left to die with the rest of the world’s prisoners. The kicker? They’re wrongfully convicted.",
        "Disease is finally eradicated. Cancer is nothing more than an old nightmare. he spent years working his way into a lab dedicated to making sure it stays that way. Their secret? They’re a hardcore believer in natural selection. He decides to take Darwinism into his own hands.",
    ],
    "fantasy":[
    ...
    "creative":[
      ...
      "Truth or Dare, he has a secret, or a truth. What are they willing to say or do to keep said truth secret.",
