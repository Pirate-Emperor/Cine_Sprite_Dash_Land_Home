        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                {/* Logo */}
                <Link to="/" className="inline-block" aria-label="CineSprite">
              ...
              <div className="text-gray-400">Cine Sprite is a Movie Database and Recommendation-Insight Generator System designed to help producers generate new title ideas while incorporating user data into the title-generation model.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; CineSprite.com. All rights reserved.</div>
