        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">
                Insights Genrator for Producers
            </h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Our Movie Idea Generator works on all kinds of inputs, so you only have to set it up once, and get beautiful results forever.
            </p>
          ...
          <div>
            ...
            <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              <div className="relative pb-9/16">
                <iframe className="absolute w-full h-full" src="https://www.youtube.com/embed/ji19tDyVzsU" title="Video" allowFullScreen></iframe>
              </div>
            </Modal>
          </div>
        </div>
